    ...
    if ~isempty(splitcom{1})
        switch splitcom{1}
            ...
            case 'sweep'
                ...
                elseif regexp(instname,'AMI')
                     if ~(strcmp(prop,'field') || strcmp(prop,'fieldc'))
                        bool=false;
                        return;
                    end
                else
                ...
                switch length(splitcom)
                    ...
                    case 9
                        ...
                        elseif regexp(instname2,'caen')
                            if ~(strcmp(prop2,'dcv0set')||strcmp(prop2,'dcv1set')...
                                    ||strcmp(prop2,'dcv2set')||strcmp(prop2,'dcv3set'))
                                bool=false;
                                return;
                            end
                        elseif regexp(instname2,'duck')
                            if ~(strcmp(prop2,'AC0')||strcmp(prop2,'AC1')||strcmp(prop2,'AC2')||strcmp(prop2,'AC3')...
                                    ||strcmp(prop2,'RF') || strcmp(prop2, 'AC') || strcmp(prop2, 'DC')...
                                    || strcmp(prop2,'DC0')||strcmp(prop2,'DC1')||strcmp(prop2,'DC2')||strcmp(prop2,'DC3')...
                                    || strcmp(prop2,'AC0AC')|| strcmp(prop2,'AC2AC')|| strcmp(prop2,'AC2AC')|| strcmp(prop2,'AC3AC')...
                                    || strcmp(prop2,'AC0DC')|| strcmp(prop2,'AC1DC')|| strcmp(prop2,'AC2DC')|| strcmp(prop2,'AC3DC'))
                                bool=false;
                                return;
                            end
                        ...
                        elseif regexp(instname2,'AMI')
                             if ~(strcmp(prop2,'field') || strcmp(prop2,'fieldc'))
                                bool=false;
                                return;
                            end
                        else
